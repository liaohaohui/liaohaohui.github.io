...
# Compare to Equation (4) in s42_logreg.pdf
lnL = function(betas) {
  beta0 = betas[1]
  beta1 = betas[2]
...
cat("
# -------------------------------------------------------------------
#  Part 2: Working with Lecture's Example 3 (single numeric input)
...
cat("
# -------------------------------------------------------------------
#  Part 3: Working with Lecture's Example 4 (single categorical input)
