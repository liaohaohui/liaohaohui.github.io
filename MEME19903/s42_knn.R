...
### Option 2: Stratified Sampling using splitstackshape
...
### Option 3: Stratified Sampling using caTools (use by dplyr)
#library(caTools)
...
# -------------------------------------------------------------------
#  Modelling & Evaluation with Holdout Method
# -------------------------------------------------------------------
...
# -------------------------------------------------------------------
# Performance of Holdout Methods
# -------------------------------------------------------------------
